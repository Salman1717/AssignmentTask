        ...
        NavigationView {
            ZStack{
                ...
                VStack(spacing: 0.0){
                    ...
                    Text("Dr. Stephen Strange casts a forbidden spell that opens the doorway to the multiverse, including alternative versions of ...")
                        .font(.subheadline)
                        .foregroundColor(.white)
                        .padding(30)
                    
                    Text("Select Date amd Time")
                        .fontWeight(.semibold)
                        .font(.title3)
                        .foregroundColor(.white)
                    ...
                    HStack(alignment: .top, spacing: 20.0){
                        DateButton(weekDay: "Thu", numDay: "20", isSelected: $bindingSelection)
                            .padding(.top, 90)
                        
                        DateButton(weekDay: "Fri", numDay: "21", isSelected: $bindingSelection)
                            .padding(.top, 70)
                        
                        DateButton(weekDay: "Sat", numDay: "22", width:70, height: 100, isSelected: $selectedDate, action: {
                        ...
                        DateButton(weekDay: "Sun", numDay: "23", isSelected: $bindingSelection)
                            .padding(.top, 70)
