...
//  MovieBooking
//
//  Created by Salman Mhaskar on 23/06/23.
//
...
struct CustomTabBar: View {
    ...
    var backgroungColors = [Color("purple"), Color("lightBlue"), Color("pink")]
    ...
    var body: some View {
        ...
        .background(LinearGradient(colors: backgroungColors, startPoint: .leading, endPoint: .trailing))
    }
